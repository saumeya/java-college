...
public class Student implements Comparable<Student> {
	...
	{
        int compareage=st.total;
        /* For Ascending order*/
       /* return this.total-compareage;

        /* For Descending order do like this */
        return compareage-this.total;
    }
    ...
    public String toString()
    {
        ...
        return "\t"+roll  + "\t" + name + "\t" + s1+ "\t" + s2 + "\t" + s3 + "\t" + s4+ "\t" + s5+ "\t"+ percent + "\t" + grade;
